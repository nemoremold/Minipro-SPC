<template>
  <view style="background: #F0F0F0;">
    ...
    <view v-if="displayButNotSetUserInfo == false" style="margin: 6px; font-size: 9pt;">
      <span>注：以上标注</span>
    ...
    <view v-if="displayButNotSetUserInfo == false" style="margin: 6px; font-size: 13pt; display: flex; flex-direction: row; justify-content: flex-start; align-items: center;">
    ...
    <view v-if="displayButNotSetUserInfo == false" style="margin: 6px 5px;">
    ...
    <view v-if="displayButNotSetUserInfo == true" style="margin: 6px 5px;">
      <van-button @click="setUserInfo" size="large" type="primary">
        {{ '编 辑' }}
      </van-button>
    </view>
...
export default {
  ...
  methods: {
    ...
    setUserInfo () {
      this.displayButNotSetUserInfo = false
    }
  }
}
</script>
