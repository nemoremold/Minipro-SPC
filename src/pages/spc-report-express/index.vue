<template>
  ...
  <view v-if="backgroundSrc" style="height: 100%; width: 100%; background: #2ebeb8 url('/static/images/background.jpeg') round; display: flex; flex-direction: column; justify-content: flex-end; align-items: center; overflow: hidden;">
    <view :style="'height: ' + viewData.title.height + 'rpx; width: ' + viewData.title.width + 'rpx; display: flex; flex-direction: column; justify-content: flex-end; align-items: center;'">
        ...
        <view :style="'position: fixed; left: 30rpx; height: ' + (viewData.title.height * 0.95) + 'rpx; width: ' + (viewData.title.height * 0.95) + 'rpx; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center;'">
          <view style="height: 90%; width: 90%; border-radius: 50%; display: flex; flex-direction: column; justify-content: center; align-items: center;">
            <view style="height: 98%; width: 98%; border-radius: 50%; background: #087376; display: flex; flex-direction: column; justify-content: center; align-items: center;">
              <view style="height: 85%; width: 85%; border-radius: 50%; background: white;">
                <image v-if="logoSrc" :src="logoSrc" mode="aspectFill" style="height: 100%; width: 100%; border-radius: 50%;" />
              </view>
            </view>
          </view>
        </view>
    ...
    <view :style="'height: ' + viewData.desc.height + 'rpx; width: ' + viewData.desc.width + 'rpx;'">
    </view>
    <view :style="'height: ' + viewData.button.height + 'rpx; width: ' + viewData.button.width + 'rpx; background: #f0bc26; display: flex; flex-direction: row; justify-content: center; align-items: center;'" @click="generateDeluxeReport">
      <span style="color: #e6551c; font-weight: bold; font-size: 17pt;">点击生成专业版报告</span>
    </view>
  </view>
</template>
